...
router.post("/add/classification", utilities.isAdmin, validator.classificationRule(), validator.checkClassificationData, utilities.handleErrors(invController.addClassification))

// Route to post new inventory
router.post("/add/inventory", utilities.isAdmin, validator.inventoryRules(), validator.checkInventoryData, utilities.handleErrors(invController.addInventory))

router.post("/update/", utilities.isAdmin, validator.inventoryRules(), validator.checkUpdateData, invController.updateInventory)
